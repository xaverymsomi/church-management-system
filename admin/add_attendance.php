    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<div class="span3" id="addattendance">
				...
				<?php	
	             $count_members=mysql_query("select * from attendance");
	             $count = mysql_num_rows($count_members);
                 ?>	 
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"></i><i class="icon-members"></i> Church Attendees</div>
								<div class="muted pull-right">
								Number of Church Attendees: <span class="badge badge-info"><?php  echo $count; ?></span>
							 </div>
                            </div>

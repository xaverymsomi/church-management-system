...
<link rel="shortcut icon" href="images/logo.png" />
	 <div class="span3" id="sidebar">
             ...
             <!--- Manage Attendance------->
						  <li>						
						    <a href="javascript:;" role="button" class="dropdown-toggle" data-toggle="collapse" data-target="#bs6"><i class="icon-chevron-right"></i><i class="icon-group"></i>&nbsp;Manage Attendance
						    <div class="muted pull-right"><i class="caret"></i></div></a>						
						    <ul id="bs6" class="collapse">						
                            <li class="">
                            <a href="add_attendance.php"><i class="icon-chevron-right"></i><i class="icon-user"></i> Add Attendance</a>
                            </li>
						   				
						    <li>
                            <a href="attendance.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i> View Attendance
							</a>
                            </li>
					  ...
					  <!------/.* manage System user sidebar*------->	
						...
						<li>						
                            ...
                            <li class="">
                            <a href="events.php"><i class="icon-chevron-right"></i><i class="icon-plus-sign-alt"></i>View Events</a>
                            </li>
						    <!-- <li class="">

        ...
        <form method="post">
          ...
          <div class="control-group">
            <p>
              <div class="controls">
                <p>
                  <input class="input focused" name="birthday" id="focusedInput" type="date" min="<?php echo date('Y-m-d') ;?>" placeholder="Birthday" required>
                </p>
              </div>
          </div>
          </p>
          ...
          <div class="control-group">
            <p>
              <div class="controls">
                <p>
                  <select class="input focused" name="memberType" id="memberType" required="required">
...
$memberType = $_POST['memberType'];
  ...
  <?php
    ...
    mysql_query("insert into members (fname,sname,lname,Gender,birthday,residence,pob,ministry,mobile,email,thumbnail,password,memberType) 
values('$fname','$sname','$lname','$Gender','$birthday','$residence','$pob','$ministry','$mobile','email','uploads/none.png','$password','$memberType')") or die(mysql_error());

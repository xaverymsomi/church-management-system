...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
                        ...
                        <div id="login" class="animate form">
                            <form  action="login.php" method="POST" autocomplete="on"> 
                                ...
                                <p class="change_link">
                                    ...
                                    <a href="../Church/admin/index.php" class="to_register">Admin</a>
								</p>
                            </form>
                        </div>
                        ...
                        <div id="register" class="animate form">
                            <form  action="reg.php" method="POST" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="usernamesignup" name="sname" required="required" type="text" placeholder="Paul"/> 
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Last Name</label>
                                    <input id="usernamesignup" name="lname" required="required" type="text" placeholder="Johny" />
                                </p>
								<p> 
  ...
  <option value="Female">Female</option>
								...
								<p> 
                                    ...
                                    <input id="usernamesignup" name="residence" required="required" type="text" placeholder="Embu" />
                                </p>
								<p> 
                                    <label for="usernamesignup" class="uname" data-icon="u">Place of Birth</label>
                                    <input id="usernamesignup" name="pob" required="required" type="text" placeholder="Kisumu" />
                                </p>
								<p> 
  ...
  <option value="Sunday School">Sunday School</option>
								 ...
								 <p> 
                                    ...
                                    <input id="emailsignup" name="email" required="required" type="email" placeholder="email@mail.com"/> 
                                </p>
                                <p> 
                                    <label for="passwordsignup" class="youpasswd" data-icon="p">Mobile Number </label>
                                    <input id="passwordsignup" name="mobile" required="required" type="text" placeholder="eg.07XXXXXXXX"/>
                                </p>
                                <p> 
